...
const MarUp = (props: { className?: string }) => {
  return (
    <div className={props.className}>
      ...
      <h4>Header 4</h4>
      <p>
        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur nisi
        augue, imperdiet ac lectus non, aliquet mollis leo. Integer eu eleifend
        tortor. Duis quis nisi vitae turpis convallis iaculis. Vestibulum at
        diam ac nulla fermentum viverra in congue quam. Quisque mattis urna id
        nisi pharetra, vel gravida mi hendrerit. Aenean mattis sem sed purus
        feugiat sodales. In semper nibh sapien, eget mattis tortor mattis ut.
        Vivamus vel pretium leo. Aenean viverra tortor laoreet neque auctor
        scelerisque. Vivamus tortor nisl, molestie ac interdum id, hendrerit
        mattis urna. Nam sem justo, aliquam nec tincidunt quis, viverra et
        nulla.
      </p>
...
const Style = () => {
  return (
    <div className="mt-44 ">
      ...
      <MarUp className="max-w-[65ch] mx-auto typo-base-size typo-base-space" />
    </div>
  );
};
